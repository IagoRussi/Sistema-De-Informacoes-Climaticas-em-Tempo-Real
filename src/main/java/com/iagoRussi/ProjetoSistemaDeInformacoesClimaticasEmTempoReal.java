...
public class ProjetoSistemaDeInformacoesEmTempoReal {
    ...
    public static String getDadosClimaticos(String cidade) throws Exception {
        ...
        //Criar objeto para enviar solicitações HTTP e receber respostas HTTP, para acessar o site da WeatherAPI
        ...
        return response.body(); //retornar os dados meteorológicos obtidos no site da API(WeatherAPI)
    }

    //Método para imprimir os dados meteorológicos de forma organizada
    public static void imprimirDadosClimaticos(String dados){
        //System.out.println("Dados originais obtidos no site meteorológico" + dados);
